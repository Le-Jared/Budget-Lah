// SUMMARY: this file handles all of the functionality to view, update, or delete a users expense history on the 'Expense History' page.
...
$('#updateModal').on('show.bs.modal', function (event) {
    ...
    let payer = button.data('payer') // Extract info from data-* attributes
    let amount = button.data('amount') // Extract info from data-* attributes
    let submitTime = button.data('submittime')
    let modal = $(this)
